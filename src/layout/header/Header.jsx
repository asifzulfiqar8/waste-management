        ...
        <div className="flex items-center justify-between gap-4 xl:gap-6">
          <div className="relative">
            <div
              ...
              ref={notificationRef}
            >
              <RiNotificationFill color="#fff" fontSize={24} />
              <p className="absolute top-0 left-[-1px] text-[8px] font-light text-white bg-[#FD4B2E] w-3 h-3 rounded-full grid place-items-center">
                9
              </p>
            </div>
            <div
              className={`absolute top-[35px] right-0 z-10 w-[320px] overflow-y-scroll border-2 border-[#e4e4e43b] shadow-md bg-white rounded-lg custom-scroll transition-all duration-700 ${
                isNotificationOpen
                  ? "h-[300px] opacity-100"
          ...
          <div className="bg-[#FFFFFF80] py-2 px-5 rounded-lg flex items-center justify-center gap-2 relative">
            ...
            >
              ...
              >
                <TbSquareRoundedChevronUpFilled color="#fff" fontSize={18} />
              </div>
            </div>
            <div
              onClick={profileOpenHandler}

...
function DriverDetail() {
    return (
        <div className='grid grid-cols-1 gap-4 lg:gap-2'>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-3 gap-4  h-full lg:h-[270px] mt-2 ">
                <WasteVolume />
                <WeeklyBinGraph />
                <BinEmptiedGraph />

            </section>
            <section className="grid overflow-auto max-h-full lg:h-[710px]  custom-scroll bg-white rounded-lg shadow-lg p-1 md:p-2 border ">
                <DriverDetails

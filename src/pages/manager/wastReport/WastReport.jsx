...
import { wastData, wastDataColumns } from './utils/wastReport';
import { wastReportTableStyle } from './utils/wastReportTableStyle';
  ...
  return (
    <div className="p-5">
      ...
      <section className="mt-4 shadow-custom p-3 w-full bg-white rounded-lg border">
        <DataTable
          columns={wastDataColumns}
          data={wastData}
          customStyles={wastReportTableStyle}
          pagination
        />
      </section>
    </div>

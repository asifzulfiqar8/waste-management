...
// import { fuelData } from '../utils/truck';


// function TruckCard({ card }) {
//     console.log("TruckCard", card)
//     return (

//         <div className=" rounded-2xl shadow-lg border-[1px] p-3">
//             <section className='flex justify-between items-center'>
//                 <section>
//                     <section className='text-lg font-bold'>
//                         {card?.id}
//                     </section>
//                     <section className='text-[#72767C] text-base font-normal'>
//                         {card?.driverName}
//                     </section>
//                 </section>
//                 <section>
...
//             <FuelCard fuelData={card?.fuelData} />
//         </div>
...
//                 <section key={index} className='flex flex-col  space-y-2 items-center'>
//                     <section>
...
//                         {item.text}
//                     </section>
//                     <section className='h-2 w-full bg-gray-200 rounded-md overflow-hidden'>
//                         <div className='h-full' style={{ width: `${item.percentage}%`, backgroundColor: item.lineColor }}></div>
//                     </section>
//                 </section>
//             ))}
//         </section>
